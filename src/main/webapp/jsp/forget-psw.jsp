...
<div class="container">
    <div class="row align-items-center">
        ...
        <div class="col-12 col-md-5 col-xl-4 order-md-1 my-5">
            ...
            <!-- Form -->
            <form action="res_password" method="POST" modelAttribute="new_user" id="newForm" >
                ...
                <div class="form-group">
                    ...
                    <div class="psw_input input-group input-group-merge">
                        ...
                        <!-- Input -->
                        <input id="re_pass" name="confirm_password" type="password" class="psw_child form-control form-control-appended" placeholder="Enter your password again " required="required"/>
                  ...
                  <span class="input-group-text">
                    ...
                    <!-- Submit -->
                    <button id="sign_up" class="btn btn-lg btn-block btn-primary mb-3" type="submit">
                        Change Password
                    </button>
